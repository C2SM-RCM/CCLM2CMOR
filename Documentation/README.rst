...
Remark by HJP, IMK-TRO/KIT, 2020-10-27:
due to the fact that the tool ran unstable when using one of tghe python versions mentioned above,
I recommend to use phython3, e.g. at DKRZ load module python3/2020.02-gcc-9.1.0
At HLRS, Stuttgart, the tool runs without any problem using python/3.8
