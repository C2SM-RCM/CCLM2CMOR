...
GCM=ERAI         # driving GCM
EXP=CTL          # driving experiment name
...
IE_TOT=450     # number of gridpoints in longitudinal direction?
JE_TOT=438     # number of gridpoints in latitudinal direction
PLEVS=(100. 200. 300. 400. 500. 600. 700. 850. 925.) # list of pressure levels to output IF NOT set in timeseries.sh. The list must be the same as or a subset	of the list in the specific GRIBOUT. 
